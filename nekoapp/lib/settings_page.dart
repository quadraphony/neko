...
class _SettingsPageState extends State<SettingsPage> {
    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          _buildDomainStrategyCard("Domain strategy for Server address", _settings.domainStrategyForServerAddress, 
          ...
          _buildTextFieldCard("Remote DNS", _settings.remoteDns, 
            (value) => _updateSetting(value, (v) => _settings.copyWith(remoteDns: v)), Icons.cloud),
          _buildDomainStrategyCard("Domain strategy for Remote", _settings.domainStrategyForRemote, 
            (value) => _updateSetting(value, (v) => _settings.copyWith(domainStrategyForRemote: v))),
          _buildTextFieldCard("Direct DNS", _settings.directDns, 
            (value) => _updateSetting(value, (v) => _settings.copyWith(directDns: v)), Icons.dns),

          const SizedBox(height: 24),

          // Inbound Settings Section
          _buildSectionHeader("Inbound Settings", Icons.input),
          _buildNumberFieldCard("Proxy Port", _settings.proxyPort, 
            (value) => _updateSetting(value, (v) => _settings.copyWith(proxyPort: v)), Icons.router),
          _buildSwitchTile(
          ...
          _buildIpv6RouteCard(),
          _buildTextFieldCard("Rule Assets Provider", _settings.ruleAssetsProvider, 
            (value) => _updateSetting(value, (v) => _settings.copyWith(ruleAssetsProvider: v)), Icons.rule),

          const SizedBox(height: 24),

          // Misc Settings Section
          _buildSectionHeader("Misc Settings", Icons.miscellaneous_services),
          _buildTextFieldCard("Connection Test URL", _settings.connectionTestUrl, 
            (value) => _updateSetting(value, (v) => _settings.copyWith(connectionTestUrl: v)), Icons.link),
          _buildSwitchTile(
            "Enable Clash API",
          ...
          _buildActionCard(
            title: "Theme",
            subtitle: _settings.theme.toString().split(".").last.toUpperCase(),
            icon: Icons.palette,
          ...
          _buildTextFieldCard(
            ...
            (value) => _updateSetting(value, (v) => _settings.copyWith(language: value)),
            Icons.language,
          ),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: ServiceMode.values.map((mode) => RadioListTile<ServiceMode>(
  ...
  void _showTunImplementationDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: TunImplementation.values.map((impl) => RadioListTile<TunImplementation>(
  ...
  void _showLogLevelDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: LogLevel.values.map((level) => RadioListTile<LogLevel>(
  ...
  void _showDomainStrategyDialog(String title, DomainStrategy current, ValueChanged<DomainStrategy> onChanged) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: DomainStrategy.values.map((strategy) => RadioListTile<DomainStrategy>(
  ...
  void _showNumberFieldCard(String title, int current, ValueChanged<int> onChanged) {
  ...
  void _showIpv6RouteDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: Ipv6Route.values.map((route) => RadioListTile<Ipv6Route>(
  ...
  void _showThemeSelectionDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: ThemeMode.values.map((themeMode) => RadioListTile<ThemeMode>(
